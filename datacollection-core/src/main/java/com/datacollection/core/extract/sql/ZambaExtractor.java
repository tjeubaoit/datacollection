package com.datacollection.core.extract.sql;

import com.datacollection.common.TextUtils;
import com.datacollection.common.config.Configuration;
import com.datacollection.core.extract.DataStream;
import com.datacollection.core.extract.StreamExtractor;
import com.datacollection.core.extract.model.GenericModel;
import com.datacollection.core.extract.model.ZambaPost;
import com.datacollection.core.platform.jdbc.ConnectionProviders;
import com.datacollection.core.platform.jdbc.JdbcConfig;
...
public class ZambaExtractor extends StreamExtractor<ResultSetAdapter> {
    ...
    protected GenericModel extractData(ResultSetAdapter rs) {
        ...
        try {
            ...
            zamba.domain = TextUtils.parseDomain(zamba.url);
