...
/**
 * Backend làm việc với các đỉnh trên HBase
 *
 * @author <a href="https://github.com/tjeubaoit">tjeubaoit</a>
 */
public class HVertexBackend extends HBaseBackend implements VertexBackend {

    public HVertexBackend(Properties props) {
        super(props);
    }
