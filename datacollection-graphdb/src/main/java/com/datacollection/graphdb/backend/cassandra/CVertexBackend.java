...
/**
 * Backend làm việc với các đỉnh trên Cassandra
 *
 * @author <a href="https://github.com/tjeubaoit">tjeubaoit</a>
 */
public class CVertexBackend extends CassandraBackend implements VertexBackend {
    ...
    public CVertexBackend(Properties props) {
        super(props);
