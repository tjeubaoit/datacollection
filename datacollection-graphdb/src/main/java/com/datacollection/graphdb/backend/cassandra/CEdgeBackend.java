...
/**
 * Backend làm việc với các cạnh trên Cassandra
 *
 * @author <a href="https://github.com/tjeubaoit">tjeubaoit</a>
 */
public class CEdgeBackend extends CassandraBackend implements EdgeBackend {
    ...
    public CEdgeBackend(Properties props) {
        super(props);
